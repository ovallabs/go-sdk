...
// RefundCustomerDeposit makes request to Torus to refund a customer deposit
func (c *Call) RefundCustomerDeposit(ctx context.Context, request model.RefundCustomerDepositRequest) error {
