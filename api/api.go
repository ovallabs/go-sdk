...
type RemoteCalls interface {
	...
	GetDepositByIDOrReference(ctx context.Context, id string, reference string) (model.Deposit, error)
	...
	GetVerifyCustomerKYC(ctx context.Context, customerID string, country *string) (model.VerifyCustomerKYCResponse, error)
