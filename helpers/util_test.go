...
func TestGetSignatureFromReferenceAndPubKey(t *testing.T) {
	tests := []struct {
		...
		{
			reference: "ref123",
			apiSecret: "IYtqe0xG0voYzbPhUEtTIEKyKj4Keq0O",
			expected:  "8c7ac3be5b0a6bee420d573325904f634f6a50ab6a5a4544b0ff8a1c7327264e",
		},
		{
			reference: "ref0091",
			apiSecret: "ANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCg",
	...
	for _, test := range tests {
		t.Run("testName", func(t *testing.T) {
			got := GetSignatureFromReferenceAndPubKey(test.reference, test.apiSecret)
